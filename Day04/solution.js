...
function solve(part) {
    ...
    for (let intervals of intervalPairs) {
        const interval1 = intervals[0].split("-").map(num => +num);
        const interval2 = intervals[1].split("-").map(num => +num);

        let result = false;
        if (part == "part1") {
            result = interval1[0] > interval2[0] ? checkIfIntervalSubset(interval2, interval1) : checkIfIntervalSubset(interval1, interval2);
        } else {
            result = interval1[0] > interval2[0] ? checkIfIntervalOverlap(interval2, interval1) : checkIfIntervalOverlap(interval1, interval2);
        }
